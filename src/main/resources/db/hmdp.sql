...
CREATE TABLE `tb_reservation`  (
  ...
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '1 RESERVED, 2 CANCELLED, 3 FINISHED',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_user_shop_time` (`user_id`, `shop_id`, `reserve_time`) USING BTREE,
  KEY `idx_reservation_user` (`user_id`, `create_time`) USING BTREE,
  KEY `idx_reservation_shop_time` (`shop_id`, `reserve_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
