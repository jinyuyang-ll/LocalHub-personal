...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public Result sendCode(String phone, HttpSession session) {
        ...
        Boolean allowSend = stringRedisTemplate.opsForValue()
                .setIfAbsent(limitKey, "1", LOGIN_CODE_LIMIT_TTL, TimeUnit.SECONDS);
        if (!Boolean.TRUE.equals(allowSend)) {
    ...
    public Result login(LoginFormDTO loginForm, HttpSession session) {
        ...
        if (failCountStr != null && Integer.parseInt(failCountStr) >= LOGIN_FAIL_MAX_TIMES) {
